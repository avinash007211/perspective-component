...
public class RadDesignerHook extends AbstractDesignerModuleHook {
    ...
    private void init() {
        ...
        registry.registerComponent(CsvToAlarmLog.DESCRIPTOR);
        registry.registerComponent(ImageTest.DESCRIPTOR);
    ...
    private void removeComponents() {
        registry.removeComponent(CsvToAlarmLog.COMPONENT_ID);
        registry.removeComponent(ImageTest.COMPONENT_ID);
