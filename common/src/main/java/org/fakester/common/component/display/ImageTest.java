...
public class ImageTest  {
    ...
    public static String COMPONENT_ID = "rad.display.imagetest";
    ...
    public static JsonSchema SCHEMA =
        JsonSchema.parse(RadComponents.class.getResourceAsStream("/radimagetest.props.json"));
    ...
    public static ComponentDescriptor DESCRIPTOR = ComponentDescriptorImpl.ComponentBuilder.newBuilder()
        ...
        .setName("Rad Image Test")
        .addPaletteEntry("", "Rad Image Test", "A simple image test component.", null, null)
        .setDefaultMetaName("radImagetest")
