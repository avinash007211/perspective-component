...
export const COMPONENT_TYPE = "rad.display.imagetest";
...
export class ImageTest extends Component<ComponentProps<ImageProps>, any> {
    render() {
...
export class ImageTestMeta implements ComponentMeta {
